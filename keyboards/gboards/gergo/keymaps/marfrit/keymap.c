 ...
 */
[_BASE] = LAYOUT_gergo(
    ALL_T(KC_ESC),   KC_K,         KC_U,         KC_Q,         LT(_ADJUST,KC_DOT), KC_J,                                                               KC_V,                LT(_ADJUST,      KC_G), KC_C,   KC_L,         KC_F, KC_BSPC,
...
[_ADJUST] = LAYOUT_gergo(
    ...
    EEP_RST, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                         KC_TRNS,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_VOLD, KC_VOLU,
