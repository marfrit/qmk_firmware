...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, XP(KC_aU, KC_AU), XP(KC_oU, KC_OU), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, XP(KC_sS, KC_SS), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
