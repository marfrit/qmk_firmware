...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_TAB,           ____HIEAO_L1____, ____HIEAO_R1____, KC_LBRC, KC_RBRC, KC_BSLS, ____DELENPD_____,          _____NUMR2T_____,
    KC_CAPS,          ____HIEAO_L2____, ____HIEAO_R2____, KC_QUOT,          KC_ENT,                             _____NUMR3T_____,
    ...
    KC_ESC,                     ____FRW1_12_____,                                    _____PRTETC_____,
    ALL_T(KC_GRV),    ___NUMBER_L1____, ___NUMBER_R1____, KC_MINS, KC_EQL,  KC_BSPC, ____INSHMPU_____,          _____NUMR1______,
    KC_TAB,           __FUNCTION_L1___, __FUNCTION_R1___, KC_LBRC, KC_RBRC, KC_BSLS, ____DELENPD_____,          _____NUMR2T_____,
    KC_CAPS,          __FUNCTION_L2___, __FUNCTION_R2___, KC_QUOT,          KC_ENT,                             _____NUMR3T_____,
