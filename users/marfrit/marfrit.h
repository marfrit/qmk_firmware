...
#define FUNCL(_KC) LT(_FUNCTIONL,   _KC)
...
#define ____HIEAO_L3____    KC_X,         RALT_T(KC_Y), FUNCL(KC_SCLN), SYMB(KC_COMM), NAVI(KC_SLSH)
#define ____HIEAO_L3_FB_    KC_X,         RALT_T(KC_Y), FUNCL(KC_SCLN), SYMB(KC_COMM), NAVI(KC_SPC)
